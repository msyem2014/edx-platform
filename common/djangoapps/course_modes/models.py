...
class CourseMode(models.Model):
    ...
    min_price = models.DecimalField(default=0.00, verbose_name=_("Price"), max_digits=30, decimal_places=2)
...
class CourseModesArchive(models.Model):
    ...
    min_price = models.DecimalField(default=0.00, max_digits=30, decimal_places=2)
